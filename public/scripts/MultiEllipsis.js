 ...
 */
    ...
    $.extend(MultiEllipsis.prototype, {
        ...
        _compareHeight : function(maxLineHeight) {
            ...
            $(self.options.targetCls).css({"height":maxLineHeight+"px","overflow":"hidden","text-overflow": "ellipsis","-webkit-line-clamp": cfg.limitLineNumber + "","display":"-webkit-box","-webkit-box-orient":"vertical"});
        },
		/*
		 * 截取文本
